...
with tf.device('/gpu:0'):
	# history = model.fit(X_train, y_train, batch_size = 256, epochs = 200, validation_data = (X_test, y_test), shuffle = False, callbacks = callbacks_list, class_weight = weights)
...
[0.6193208694458008, 0.9440982341766357]
Confusion Matrix
              precision    recall  f1-score   support

           0       1.00      0.95      0.97    168546
           1       0.19      0.73      0.30      2826

    accuracy                           0.94    171372
   macro avg       0.59      0.84      0.64    171372
weighted avg       0.98      0.94      0.96    171372
